...
class PaymentAdmin(ImportExportModelAdmin):
    list_display = ('id', 'user', 'hours', 'start_date', 'end_date', 'price_per_hour', 'total_price', 'created_at', 'updated_at')
...
class PaymentHistoryAdmin(ImportExportModelAdmin):
    list_display = ('id', 'user_full_name', 'user_passport_id', 'start_date', 'end_date', 'hours_worked', 'hourly_rate', 'total_price', 'created_at', 'updated_at')
    list_filter = ('start_date', 'end_date', 'created_at', 'updated_at')
